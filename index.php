...
<?php
    ...
    $maxSec = fnQueryChart("select MAX(secondi) as valore FROM tablenew;","valore");
?>
<!DOCTYPE html>
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-3">
            ...
            <div class="row">
                <div class="col-12 ctnDrone">
                    <img src="img/drone_4.png" class="img-fluid" />
                </div>
            </div>
        </div>
        <div class="col-6">
...
<script type="text/javascript">
    ...
    function GetMaxSeconds() {
        ...
        var sql = "SELECT MAX(secondi) as valore FROM tablenew;";
        var field = 'valore';
        return $.ajax({
            method: "POST",
